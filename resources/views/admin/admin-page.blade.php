...
{{-- GREETING --}}
<div class="greeting">
    <h3>Halo, {{ auth()->user()->name ?? 'Admint' }}</h3>
</div>
...
<div class="user-section">
    <div class="menu">
        ...
        <a href="/diproses-admin" class="menu-shipping">
            <img src="{{ asset('images/processed.png') }}">
            <p>Diproses</p>
        </a>

        <a href="/dikirim-admin" class="menu-finished">
            <img src="{{ asset('images/shipping.png') }}">
            <p>Dikirim</p>
        </a>

        <a href="/history-admin" class="menu-catalog">
